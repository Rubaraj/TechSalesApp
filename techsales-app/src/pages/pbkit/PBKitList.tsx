  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Plan Bundle Kit (PBKit)</h1>
      ...
      {isLoading ? (
        ...
        <EmptyState
          icon={Mail}
          title="No PBKit records found"
          description="Create a new PBKit to send plan information"
          action={<Button onClick={() => setIsCreateOpen(true)}><Plus className="w-4 h-4" />New PBKit</Button>}
        />
      ) : (
