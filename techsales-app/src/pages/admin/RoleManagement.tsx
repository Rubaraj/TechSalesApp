...
const availablePermissions = [
  ...
  { key: 'pba.view', label: 'View SOA', category: 'SOA' },
  { key: 'pba.manage', label: 'Manage SOA', category: 'SOA' },
  { key: 'pbkit.view', label: 'View P-EKIT', category: 'P-EKIT' },
  { key: 'pbkit.manage', label: 'Manage P-EKIT', category: 'P-EKIT' },
