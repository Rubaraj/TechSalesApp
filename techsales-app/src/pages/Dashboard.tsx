...
export function Dashboard({ tab }: DashboardProps) {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setRecentActivities([
        { id: '1', type: 'lead', action: 'Created', subject: 'John Smith', timestamp: '10 minutes ago', status: 'New' },
        ...
        { id: '5', type: 'lead', action: 'Updated', subject: 'James Wilson', timestamp: 'Yesterday', status: 'Qualified' },
      ]);
      setAppointments([
  ...
  const stats = [
    { title: 'Total Leads', value: '156', icon: Users, change: 12, changeLabel: 'vs last month', color: 'blue' as const },
  ...
  const navigationTiles = [
    { title: 'Leads', description: 'Manage prospects and contacts', icon: Users, to: '/leads', color: 'blue' as const, count: 156, module: 'leads' as const },
    ...
    <div className="flex gap-4 relative">
      ...
      {!isPanelOpen && (
        <button
          ...
          className="fixed bottom-6 left-6 z-50 sm:hidden w-14 h-14 bg-gradient-to-br from-orange-500 to-amber-600 rounded-full shadow-lg flex items-center justify-center text-white hover:from-orange-600 hover:to-amber-700 transition-all"
        >
      ...
      >
        <div 
          className="sticky top-20 bg-gradient-to-b from-orange-500 via-orange-600 to-amber-600 rounded-2xl text-white shadow-xl overflow-hidden"
          style={{
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto space-y-4 pr-1" style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(255,255,255,0.3) transparent' }}>
              ...
              <div className="pr-8">
                ...
                <p className="text-orange-100 text-sm whitespace-nowrap">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-white/15 backdrop-blur rounded-lg px-3 py-2">
                  <p className="text-xs text-orange-100">Appointments</p>
                  <p className="text-lg font-bold">3</p>
                </div>
                <div className="bg-white/15 backdrop-blur rounded-lg px-3 py-2">
                  <p className="text-xs text-orange-100">Follow-ups</p>
              ...
              <div>
                <Link
                  to="/leads/new"
                  className="w-full flex items-center justify-center gap-1.5 px-3 py-2 bg-white text-orange-700 rounded-lg text-sm font-medium hover:bg-orange-50 transition-colors whitespace-nowrap"
                >
              ...
              <div className="space-y-1">
                <p className="text-xs text-orange-200 uppercase tracking-wider mb-2">Quick Access</p>
            ...
            <div className="pt-3 mt-3 border-t border-white/20 flex-shrink-0">
              <div className="bg-white/15 rounded-lg p-3">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-xs text-orange-100">Monthly Goal</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link to="/leads" className="text-sm text-orange-600 hover:underline flex items-center gap-1">
                        ...
                        >
                          ...
                          {activity.status && (
                            <Badge variant={
                              ...
                              activity.status === 'Qualified' ? 'primary' : 'default'
                            }>
                              {activity.status}
                            </Badge>
                          )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link to="/pba" className="text-sm text-orange-600 hover:underline flex items-center gap-1">
                    View all <ArrowRight className="w-4 h-4" />
                  </Link>
                </div>
                ...
                {appointments.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-32 text-gray-500 dark:text-gray-400">
                    ...
                    <Link to="/pba" className="text-orange-600 hover:underline mt-1">
                      Schedule one
                    </Link>
                  </div>
                ) : (
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link to="/plans" className="text-sm text-orange-600 hover:underline flex items-center gap-1">
                    View all <ArrowRight className="w-4 h-4" />
                  </Link>
                </div>
