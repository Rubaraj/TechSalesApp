  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Plan Briefing Appointment</h1>
          <p className="text-gray-500 dark:text-gray-400">
            Manage PBA forms for Medicare sales appointments
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <SearchInput
          ...
          placeholder="Search by lead name or PBA ID..."
      ...
      {isLoading ? (
        ...
        <EmptyState
          icon={FileText}
          title="No PBA records found"
          description="Create a new PBA to get started"
          action={<Button onClick={() => setIsCreateOpen(true)}><Plus className="w-4 h-4" />New PBA</Button>}
        />
      ) : (
        ...
        {selectedPBA && (
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">PBA ID</p>
      ...
      <Modal
        ...
        title="Create New PBA"
        size="lg"
        footer={
          <>
            <Button variant="outline" onClick={() => setIsCreateOpen(false)}>Cancel</Button>
            <Button onClick={() => setIsCreateOpen(false)}>Create PBA</Button>
          </>
        }
      >
