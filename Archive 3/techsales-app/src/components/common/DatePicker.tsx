  ...
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      ...
      if (
        ...
        !(target instanceof Element && target.closest('.fixed.z-\\[9999\\]'))
      ) {
        setIsOpen(false);
      }
    }
    ...
    <div className="w-full" ref={containerRef}>
      ...
      <div className="relative">
        ...
        {isOpen && dropdownPosition && createPortal(
          <div 
            className="fixed z-[9999] w-80 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200"
            style={{
